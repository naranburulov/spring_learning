...
//
//    @Before("myPointcut()")                                 //advice
//    public void log(){
//        logger.info("Info log..............");
//    }

//    @Before("execution(* com.cydeo.controller.CourseController.*(..))")            //advice
//    public void log(){
//        logger.info("Info log..............");
//    }
...
//    @Pointcut("@annotation(org.springframework.web.bind.annotation.DeleteMapping)") //@DeleteMapping annotation will be applied for
...
//    public void afterReturningGetMappingOperation(JoinPoint joinPoint, Object results){
//        logger.info("After -> Method: {}, Result: {}"
//                , joinPoint.getSignature(), joinPoint.getSignature(), joinPoint.toString());
//    }
...
//        logger.info("After -> Method: {}, Result: {}"
//                , joinPoint.getSignature(), joinPoint.getSignature(), results.toString());
//    }
