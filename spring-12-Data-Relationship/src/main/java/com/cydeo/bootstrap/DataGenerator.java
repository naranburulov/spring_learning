...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1 = new Customer("1212 Oliver St, Reston, VA", "john@gmail.com","John","Smith","jsmith");
        Customer customer2 = new Customer("2431 Hall St, Fairfax, VA", "ashley@gmail.com","Ashley","Hamilton","ahamilton");
